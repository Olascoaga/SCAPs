# -*- coding: utf-8 -*-
"""
Created on Wed Mar 13 15:30:26 2024
...
#Background images
background_image_control = Image.open('') 
background_image_senes = Image.open('')
...
pixel_values_ctrl = process_images('SENES', background_intensity_control)
pixel_values_senes = process_images('CTRL', background_intensity_senes)
...
bar_plot.set_xticklabels(['Control', '', 'RS', ''], fontsize=18)
bar_plot.set_ylabel('Mean Pixel Intensity', fontsize=18)
bar_plot.set_title(' ', fontsize=16)
sns.despine()
plt.savefig('CASP3.png', dpi=900) 
plt.show()